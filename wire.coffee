...
wires =
  jesse: [
    ...
    {channel: 'twitter', uid: 'jessethegame'}
  ]
  ...
  josh: [
    ...
    {channel: 'twitter', uid: 'mcmillatronic'}
  ]
...
broadcast = (body) ->
  console.log "wire.broadcast", {body}
  Fallback.send id, {body} for id of wires
